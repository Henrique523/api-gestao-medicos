...
export class InitialTables1623946807104 implements MigrationInterface {
    name = 'InitialTables1623946807104'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `Doctors` (`id` int NOT NULL AUTO_INCREMENT, `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `deleted_at` timestamp(6) NULL, `name` varchar(255) NOT NULL, `crm` varchar(255) NOT NULL, `phone` varchar(255) NOT NULL, `cellphone` varchar(255) NOT NULL, `cep` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
